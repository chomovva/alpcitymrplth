...
<form class="form" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6">
			<label for="account_first_name"><?php esc_html_e( 'First name', 'woocommerce' ); ?>&nbsp;<span class="text-warning">*</span></label>
		...
		<div class="col-xs-12 col-sm-6">
			<label for="account_last_name"><?php esc_html_e( 'Last name', 'woocommerce' ); ?>&nbsp;<span class="text-warning">*</span></label>
	...
	<div class="form-group">
		<label for="account_display_name"><?php esc_html_e( 'Display name', 'woocommerce' ); ?>&nbsp;<span class="text-warning">*</span></label>
		...
		<span class="small font-style-italic"><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'woocommerce' ); ?></span>
	</div>

	<div class="form-group">
		<label for="account_email"><?php esc_html_e( 'Email address', 'woocommerce' ); ?>&nbsp;<span class="text-warning">*</span></label>
	...
	<fieldset class="mt-2 pl-3 pr-3 pt-0 pb-3">
