...
add_action( 'template_redirect', 'alpcitymrplth\single_result_redirect' );
...
add_filter( 'the_content', 'alpcitymrplth\search_backlight' );

add_filter( 'get_the_excerpt', 'alpcitymrplth\search_backlight' );

add_filter( 'the_title', 'alpcitymrplth\search_backlight' );
...
add_filter( 'the_permalink', 'alpcitymrplth\add_search_key_for_backlight', 10, 2 );