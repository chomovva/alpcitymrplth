...
function customizer_register_error404( $wp_customize ) {
	...
	$wp_customize->add_section(
		ALPCITYMRPLTH_SLUG . '_error404',
		[
			'title'            => __( '404', ALPCITYMRPLTH_TEXTDOMAIN ),
			'description'      => __( 'Страница ошибки 404 (шаблон 404.php)', ALPCITYMRPLTH_TEXTDOMAIN ),
			'priority'         => 20,
	...
	$wp_customize->add_control(
		'error404title',
		[
			'section'           => ALPCITYMRPLTH_SLUG . '_error404',
			'label'             => __( 'Заголовок', ALPCITYMRPLTH_TEXTDOMAIN ),
			'type'              => 'text',
		]
	);
...
add_action( 'customize_register', 'alpcitymrplth\customizer_register_error404', 10, 1 );